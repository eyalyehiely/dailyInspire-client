        ...
        <div className="relative">
          <div className="text-center">
            ...
            <p className="mt-3 max-w-2xl mx-auto text-xl text-gray-500 sm:mt-4">
              Join thousands of people who have transformed their daily routine with our inspirational quotes.
            </p>
          </div>
                ...
                <div className={`flex-1 bg-white p-6 flex flex-col justify-between border-t-4 bg-gradient-to-r ${testimonial.color}`}>
                  ...
                  <div className="mt-6 flex items-center">
                    <div className="flex-shrink-0">
                      <img className="h-10 w-10 rounded-full ring-2 ring-indigo-500" src={testimonial.image} alt="" />
                    </div>
                    <div className="ml-3">
